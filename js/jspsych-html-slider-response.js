...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function custom_continue_on_enter_keypress(e) {
    ...
    if(trial.require_movement){
      display_element.querySelector('#jspsych-html-slider-response-response').addEventListener('change', function(){
        ...
        //my own code below to add enter event listener
        display_element.addEventListener('keypress', custom_continue_on_enter_keypress);
      })
    }
    ...
    function end_trial(){
      ...
      display_element.removeEventListener('keypress', custom_continue_on_enter_keypress)
