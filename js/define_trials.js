...
var information_sampling_2_optional = {
	...
	on_finish: function(data) {
		...
		last_card_decision_trial_data = jsPsych.data.get().filter({trial_name: 'card_decision'}).last(1).values()[0]
		console.log(last_card_decision_trial_data[0])
		console.log(last_card_decision_trial_data[0]['rt'])
